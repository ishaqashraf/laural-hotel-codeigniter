  ...
  <div class="row">
    <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Table's Details</h3>
                    <button type="submit" class="btn btn-primary pull-right" data-toggle="modal" 
                  data-target="#add_table">Add New Table</button>
        ...
        <div class="box-body">
             <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php foreach($showtable as $t):?>
                <tr>
                  <td><?php echo $t->tableid ?></td>
                  <td><?php echo $t->TableNumber ?></td>
                  <td><?php echo $t->TableType ?></td>
                  <td><?php echo $t->Price ?></td>
                  <td><img src="<?php echo base_url() ?>/uploads/<?php echo $t->Image ?>" alt="" style="height: 40px; width: 60px;"/></td>                  
                  <td><?php echo $t->Status ?></td>
                  <td>
                  <a class="editBtn" data-toggle="modal" 
                  data-target="#edit_table" data-id ="<?php echo $t->tableid ?>">  
                   <i class="glyphicon glyphicon-plus"></i></a>

                   &nbsp;&nbsp;&nbsp;
                     <a href="<?php echo site_url('admin/hotelController/deletetable')?>/<?php echo $t->tableid ?>">
...
<div id="edit_table" class="modal fade">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="<?php echo site_url('admin/hotelController/tableedited')?>" method="POST" enctype="multipart/form-data">
...
<div id="add_table" class="modal fade">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                ...
                <form action="<?php echo site_url('admin/hotelController/addtable')?>" method="POST" enctype="multipart/form-data">
                  <div class="modal-body">
                    <div class="form-group">
                      <div class="row">
                          <div class="col-sm-6">
...
<script type="text/javascript">
  $('.editBtn').on('click',function(){
    ...
    var id = $(this).data("id");
     var url = '<?php echo site_url("admin/hotelController/edittable") ?>'+'/'+id;
