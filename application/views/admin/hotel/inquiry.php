  ...
  <div class="row">
    <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Inquiry's Details</h3>
                    <!-- <button type="submit" class="btn btn-primary pull-right" data-toggle="modal" 
                  data-target="#add_booking">Add New Inquiry</button>
 -->
        </div>
        <div class="box-body">
             <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php foreach($showInquiry as $s):?>
                <tr>
                  <td><?php echo $s->inquiry_Id ?></td>
                  <td><?php echo $this->HotelModel->getReservationByType($s->Reservation_Id,$s->typeid) ?></td>
                  <td><?php echo $s->TypeName ?></td>
                 ...
                 <!--  <a class="editBtn" data-toggle="modal" 
                  data-target="#edit_Inquiry" data-id ="<?php echo $s->Id ?>">  
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          ...
                          <select class="form-control" name="Room_Id" id="Room_Id">
                            <?php foreach($showroom as $a):?>
                             <option value="<?php echo $a->Id ?>"><?php echo $a->RoomNumber ?></option>
                            <?php endforeach?>
                          </select>
                        ...
                        <div class="col-sm-6">
                          <label>UserName</label>
                           <select class="form-control" name="User_Id">
                            <?php foreach($showusers as $b):?>
                             <option value="<?php echo $b->Id ?>"><?php echo $b->UserName ?></option>
                            <?php endforeach?>
                          </select>
