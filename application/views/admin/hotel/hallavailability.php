  ...
  <div class="row">
    <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Hall Availability's Details</h3>
        ...
        <div class="box-body">
             <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php foreach($showavailability as $a):?>
                <tr>
                ...
                <!--   <td><?php echo $a->FromDate ?></td>
                  ...
                  data-target="#edit_availability" data-id ="<?php echo $a->aID ?>">  
                   ...
                   &nbsp;&nbsp;&nbsp;
                     <a href="<?php echo site_url('admin/hotelController/deletehallavailability')?>/<?php echo $a->aID ?>">
...
<div id="edit_availability" class="modal fade">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="<?php echo site_url('admin/hotelController/hallavailabilityedited')?>" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                          ...
                          <select class="form-control" name="Type" id="Type">
                            <?php foreach($showtype as $s):?>
                             <option value="<?php echo $s->Id ?>"><?php echo $s->TypeName ?></option>
                            <?php endforeach?>
                          </select>
                        ...
                        <div class="col-sm-6">
                          ...
                          <select class="form-control" name="room_hall_id" id="room_hall_id">
                            <?php foreach($showroomid as $rh):?>
                             <option value="<?php echo $rh->Id ?>"><?php echo $rh->Name ?></option>
                            <?php endforeach?>
                          </select>
...
<div id="add_availability" class="modal fade">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="<?php echo site_url('admin/hotelController/addhallavailability')?>" method="POST">
                  <div class="modal-body">
                    <div class="form-group">
                          <div class="row">
                          <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                          ...
                          <select class="form-control" name="room_hall_id">
                            <?php foreach($showroomid as $rh):?>
                             <option value="<?php echo $rh->Id ?>"><?php echo $rh->Name ?></option>
                            <?php endforeach?>
                          </select>
...
<script type="text/javascript">
  $('.editBtn').on('click',function(){
    ...
    var id = $(this).data("id");
     var url = '<?php echo site_url("admin/hotelController/edithallavailability") ?>'+'/'+id;
