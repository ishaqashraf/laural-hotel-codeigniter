  ...
  <div class="row">
    <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Dishe's Details</h3>
                    <button type="submit" class="btn btn-primary pull-right" data-toggle="modal" 
                  data-target="#add_dish">Add New Dish</button>
        ...
        <div class="box-body">
             <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php foreach($showdish as $d):?>
                <tr>
                  <td><?php echo $d->Id ?></td>
                  <td><?php echo $d->DishName ?></td>
                  <td><?php echo $d->Description ?></td>
                  <td><?php echo $d->Price ?></td>
                  <td><img src="<?php echo base_url() ?>/uploads/<?php echo $d->Image ?>" alt="" style="height: 40px; width: 60px;"/></td>                  
                  <td><?php echo $d->Status ?></td>
                  <td>
                  <a class="editBtn" data-toggle="modal" 
                  data-target="#edit_dish" data-id ="<?php echo $d->Id ?>">  
                   <i class="glyphicon glyphicon-plus"></i></a>

                   &nbsp;&nbsp;&nbsp;
                     <a href="<?php echo site_url('admin/hotelController/deletedish')?>/<?php echo $d->Id ?>">
...
<div id="edit_dish" class="modal fade">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="<?php echo site_url('admin/hotelController/dishedited')?>" method="POST"
...
<div id="add_dish" class="modal fade">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                ...
                <form action="<?php echo site_url('admin/hotelController/adddish')?>" method="POST"
                enctype="multipart/form-data">
                  <div class="modal-body">
                    <div class="form-group">
                      <div class="row">
...
<script type="text/javascript">
  $('.editBtn').on('click',function(){
    ...
    var id = $(this).data("id");
     var url = '<?php echo site_url("admin/hotelController/editdish") ?>'+'/'+id;
