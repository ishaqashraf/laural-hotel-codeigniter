  ...
  <div class="row">
    <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Room's Details</h3>
                    <button type="submit" class="btn btn-primary pull-right" data-toggle="modal" 
                  data-target="#add_roomhall">Add New room</button>
 ...
 -->              <th>Image</th>
                ...
                <tr>
                  ...
                  data-target="#edit_roomhall" data-id ="<?php echo $r->roomhallid ?>">  
                   ...
                   &nbsp;&nbsp;&nbsp;
                     <a href="<?php echo site_url('admin/hotelController/deleteroom')?>/<?php echo $r->roomhallid ?>">
...
<div id="edit_roomhall" class="modal fade">
          ...
          <form action="<?php echo site_url('admin/hotelController/roomedited')?>" method="POST" enctype="multipart/form-data">
...
<div id="add_roomhall" class="modal fade">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="<?php echo site_url('admin/hotelController/addroom')?>" method="POST" enctype="multipart/form-data">
                  <div class="modal-body">
                    <div class="form-group">
                      <div class="row">
                         <div class="col-sm-6">
...
<script type="text/javascript">
  $('.editBtn').on('click',function(){
    ...
    var id = $(this).data("id");
     var url = '<?php echo site_url("admin/hotelController/editroom") ?>'+'/'+id;
