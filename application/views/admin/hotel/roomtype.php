    ...
    <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Room Type'Details</h3>
                  ...
                  data-target="#add_room_type">Add New Type</button>
        ...
        <div class="box-body">
             <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php foreach($showroomtype as $rt):?>
                <tr>
                  ...
                  data-target="#edit_room_type" data-id ="<?php echo $rt->Id ?>">  
                   <i class="glyphicon glyphicon-plus"></i></a>

                   &nbsp;&nbsp;&nbsp;
                     <a href="<?php echo site_url('admin/hotelController/deleteroomtype')?>/<?php echo $rt->Id ?>">
...
<div id="edit_room_type" class="modal fade">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="<?php echo site_url('admin/hotelController/roomtypeedited')?>" method="POST">
...
<br>
                            <label>
                        <input type="radio" value="1" id="Status" name="Status"> Enable
                      </label>
                        <br>
                      <label>
                        <input type="radio" value="0" id="Status" name="Status"> Disable
                      </label>
...
<div id="add_room_type" class="modal fade">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                ...
                <form action="<?php echo site_url('admin/hotelController/addroomtype')?>" method="POST">
                  <div class="modal-body">
                    <div class="form-group">
                      <div class="row">
                        <div class="col-sm-6">
...
<script type="text/javascript">
  $('.editBtn').on('click',function(){
    ...
    var id = $(this).data("id");
     var url = '<?php echo site_url("admin/hotelController/editroomtype") ?>'+'/'+id;
