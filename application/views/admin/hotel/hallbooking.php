  ...
  <div class="row">
    <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"> Hall Booking's Details</h3>
 ...
 -->                  <td><?php echo $b->TypeName ?></td>
               ...
               <!--    <a class="editBtn" data-toggle="modal" 
                  data-target="#edit_booking" data-id ="<?php echo $b->bookingId ?>">  
                   ...
                   &nbsp;&nbsp;&nbsp;
                     <a href="<?php echo site_url('admin/hotelController/deleteHallBooking')?>/<?php echo $b->bookingId ?>">
...
<div id="add_booking" class="modal fade">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="<?php echo site_url('admin/hotelController/addHallBooking')?>" method="POST">
                  <div class="modal-body">
                    <div class="form-group">
                      <div class="row">
                       <!--  <div class="col-sm-6">
