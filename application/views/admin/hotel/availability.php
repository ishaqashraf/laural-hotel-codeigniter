  ...
  <div class="row">
    <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Room Availability's Details</h3>
             ...
             <table id="example1" class="table table-bordered table-striped">
                ...
                <!--   <td><?php echo $a->FromDate ?></td>
                  ...
                  data-target="#edit_availability" data-id ="<?php echo $a->aID ?>">  
                   ...
                   &nbsp;&nbsp;&nbsp;
                     <a href="<?php echo site_url('admin/hotelController/deleteavailability')?>/<?php echo $a->aID ?>">
...
<div id="edit_availability" class="modal fade">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="<?php echo site_url('admin/hotelController/availabilityedited')?>" method="POST">
...
<div id="add_availability" class="modal fade">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="<?php echo site_url('admin/hotelController/addavailability')?>" method="POST">
                  <div class="modal-body">
                    <div class="form-group">
                          <div class="row">
                          <div class="col-sm-6">
...
<script type="text/javascript">
  $('.editBtn').on('click',function(){
    ...
    var id = $(this).data("id");
     var url = '<?php echo site_url("admin/hotelController/editavailability") ?>'+'/'+id;
