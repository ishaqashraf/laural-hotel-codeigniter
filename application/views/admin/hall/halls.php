    ...
    <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Hall's Details</h3>
                  ...
                  data-target="#add_hall">Add New Hall</button>
        ...
        <div class="box-body">
             <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $h->RemainingPrice ?></td>
                  <td><?php echo $h->Image ?></td>
                  <td><?php echo $h->Date ?></td>
                  <td><?php echo $h->Status ?></td>
                  <td>
                  <a class="editBtn" data-toggle="modal" 
                  data-target="#edit_hall" data-id ="<?php echo $h->Id ?>">  
                   <i class="glyphicon glyphicon-plus"></i></a>

                   &nbsp;&nbsp;&nbsp;
                     <a href="<?php echo site_url('admin/hallController/deletehall')?>/<?php echo $h->Id ?>">
...
<div id="edit_hall" class="modal fade">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="<?php echo site_url('admin/hallController/halledited')?>" method="POST">
...
<div id="add_hall" class="modal fade">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                ...
                <form action="<?php echo site_url('admin/hallController/addhall')?>" method="POST">
                  <div class="modal-body">
                    <div class="form-group">
                      <div class="row">
                         <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                          <label>Type</label>
                          <input type="text" name="Type"  value="1" class="form-control" disabled>
                      </div>
                       <div class="col-sm-6">
                          <label>Price</label>
                    ...
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <label>Remaining Price</label>
                          <input type="text" name="RemainingPrice"  class="form-control">
                        </div>
...
<script type="text/javascript">
  $('.editBtn').on('click',function(){
    ...
    var id = $(this).data("id");
     var url = '<?php echo site_url("admin/hallController/edithall") ?>'+'/'+id;
     ...
     $.ajax({
         ...
         success: function(response){
              ...
              $('#Name').val(data.Name);
                ...
                $('#RemainingPrice').val(data.RemainingPrice);
