					...
					<div class="col-md-12">
						<div class="mg-booking-form">
							...
							<div class="tab-content">
								...
								<div role="tabpanel" class="tab-pane fade in active" id="thank-you">
									<div class="alert alert-success alert-dismissible clearfix">
										...
										<h3 class="mg-alert-payment">Thank you! Your Registration is confirmed. Invoice Sent in your email address</h3>
									</div>

									<a href="<?php echo site_url('welcome/login') ?>"><button class="btn btn-main pull-left">Back To Login
									</button></a>
