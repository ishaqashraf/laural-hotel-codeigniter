...
<html lang="en">
	...
	<body>
		...
		<div class="mg-rooms-cols">
			<div class="container">
				<div class="row">
					 <?php foreach($showtable as $st):?>					
					<div class="col-md-3 col-xs-6">
						<figure class="mg-room mg-room-col-4">
							<img src="<?php echo base_url() ?>/uploads/<?php echo $st->Image ?>" alt=""  class="img-responsive"/>							
							<figcaption>
								<h2><?php echo "Table ".$st->TableNumber ?></h2>
								<div class="mg-room-rating"><i class="fa fa-star"></i> 5.00</div>
								<div class="mg-room-price"><?php echo $st->Price ?><sup>.99/Night</sup>
								</div>
								<!-- <a href="#" class="btn btn-link">View Details <i class="fa fa-angle-double-right"></i></a> -->
								<a href="<?php echo site_url('welcome/singletable') ?>/<?php echo $st->tableid ?>" class="btn btn-main">Book</a>
							</figcaption>			
						</figure>
					</div>
						<?php endforeach ?>
