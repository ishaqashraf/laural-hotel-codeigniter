...
<a href="<?php echo site_url('welcome/singleroom') ?>/<?php echo $r->searchid ?>" class="btn btn-link">View Details <i class="fa fa-angle-double-right"></i></a>

<?php

$this->load->model('HotelModel');
$num = $this->HotelModel->checkifBooked($r->searchid);
if(count($num) > 0)
{
?>	
<a href="#" class="btn btn-main book" style="background-color:#7B0F72; " disabled>Booked</a>
<?php
}
else
{
?>	
<a href="<?php echo site_url('welcome/booking') ?>/<?php echo $r->searchid ?>/<?php echo $from ?>/<?php echo $to ?>/<?php echo $r->aid ?>" class="btn btn-main book">Book</a>
<?php
}
